...
** Painters tape: https://www.amazon.com/ScotchBlue-Painters-Multi-Use-1-88-Inch-60-Yard/dp/B008WZZ11S[ScotchBlue 1.88 inch x 60 yards]. Going above 2cm wide for vinyl strips is usually not recommended, therefore we don't need painters tape wider than this.
