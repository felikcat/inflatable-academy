...
== Appendices
. Contains some of the images used to demonstrate seam types: https://meh.com/forum/topics/inflatable-of-the-day-45

. Some images were used from their catalog: https://www.inflatableworld-wsp.de/
